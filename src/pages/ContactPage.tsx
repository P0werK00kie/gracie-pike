  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        <Header />
        <main>
          <section className="pt-32 pb-20 bg-gradient-to-br from-burgundy-50/30 to-amber-50/20 relative overflow-hidden">
              ...
              <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto">
                ...
                <div className="flex-1 lg:w-[45%]">
                  <div className="bg-card border border-amber-200 luxury-shadow p-8">
                    <h2 className="text-3xl font-display font-bold text-burgundy-900 mb-8 text-center">Send a Message</h2>
                ...
                <div className="flex-1 lg:w-[45%]">
                  <div className="bg-card border border-amber-200 luxury-shadow p-8">
                    <h2 className="text-3xl font-display font-bold text-burgundy-900 mb-8 text-center">Book a Show</h2>
